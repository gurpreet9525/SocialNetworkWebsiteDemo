...
$query_user = "SELECT user_status, user_portrait_path, username FROM UserInfo  WHERE UserId = '$userId'";
...
$userName = $query_result_user[2];


$query_recent = "SELECT PostId, UserId, PostType, PostTime, LocationId, PostAuthId FROM UserPost WHERE userid = '$userId' ORDER BY PostTime DESC LIMIT $newPage, 8";
...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-2 column">
            <img alt="140x140" onclick="location='profile.php?uid=<?php echo $_GET['uid']?>'" style="cursor: pointer" src=<?php echo ($userPortrait == null ? "img/defaultP.jpg" : $userPortrait);?> />
            <br />
            <dl>
                <dt>
        ...
        <div class="col-md-7 column">
            ...
            <button class="btn btn-primary btcb" data-toggle="modal" data-target="#uploadImg">
                <span class="glyphicon glyphicon-picture" aria-hidden="true"></span>
            </button>
            <button class="btn btn-primary btcb" data-toggle="modal" data-target="#uploadVideo">
                <span class="glyphicon glyphicon-facetime-video" aria-hidden="true"></span>
            </button>
            <button class="btn btn-primary btcb" data-toggle="modal" data-target="#uploadVideo" onclick="location='diarypost.php'">

...
$query = "SELECT FirstName, LastName, CityName, user_title, birth, user_status , gender, user_portrait_path FROM UserInfo NATURAL JOIN CityTable WHERE UserId = '$uid'";
...
<!--                        <input class="inp1" type="text" name="username" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Username"-->
<!--                               value=--><?php //echo $username;?><!-->
<!--                    </div>-->
<!--                    <div class="panel-body">-->
<!--                        <label>First Name * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>-->
<!--                        <input class="inp1" type="text" name="firstName" required="true" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;First Name"-->
<!--                               value=--><?php //echo $FirstName;?><!-->
<!--                    </div>-->
<!--                    <div class="panel-body">-->
<!--                        <label>Last Name * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>-->
<!--                        <input class="inp1" type="text" name="lastName" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Last Name" required="true"-->
<!--                               value=--><?php //echo $LastName;?><!-->
<!--                    </div>-->
<!---->
<!--                    <div class="panel-body">-->
<!--                        <label>Title&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>-->
<!--                        <input class="inp1" type="text" name="title" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Title"-->
...
<!--                        <input class="inp1" type="date" name="birth"-->
<!--                               value=--><?php //echo $birth;?><!-->
<!--                    </div>-->
<!---->
<!--                    <div class="panel-body">-->
<!--                        <label>Gender *</label>-->
<!--                        <select class="form-control inp1" name="gender" value=--><?php //if($gender != null) echo $gender;?><!-->
<!--                            <option>Male</option>-->
...
<!--                        <input class="inp1" type="text" name="residence" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;City of Residence"-->
<!--                               value=--><?php //echo $city;?><!-->
<!--                    </div>-->
<!---->
<!--                    <div class="panel-body">-->
<!--                        <label>Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
<!--                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>-->
<!--                        <input class="inp1" type="text" name="status" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;statue"-->
